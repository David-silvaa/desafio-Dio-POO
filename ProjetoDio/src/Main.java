...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Conteúdos Inscritos David: " + devDavid.getConteudoInscritos());
        devDavid.progredir();
        devDavid.progredir();
        devDavid.progredir();
        devDavid.progredir();
        ...
        System.out.println("Conteúdos Inscritos David: " + devDavid.getConteudoInscritos());
        System.out.println("Conteúdos Concluidos David: " + devDavid.getConteudoConcluidos());
